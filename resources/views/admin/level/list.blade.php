    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading danger">
                <p style="color:#337ab7">{{ count($level) }} Levels / {{ count($role) }} Roles</p>
            </div>
                            ...
                            @foreach($level as $key => $value)
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        <label>
                                            <button class="btn btn-link"><a href="{{ route('admin.level.edit', $value->id) }}"><i class="glyphicon glyphicon-pencil"></i></a></button> &nbsp;&nbsp;&nbsp;
                                        </label>
                                        <label>
                                            {!! Form::open( array( 'route' => array('admin.level.destroy',$value->id), 'method' => 'DELETE' ) ) !!}
